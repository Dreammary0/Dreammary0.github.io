...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"../src/pilots/script.js":[function(require,module,exports) {
...
var gridArr = Array.prototype.slice.call(sqrs);
var test = false;
var test1 = false;
...
function Show() {
  for (var i = 0; i < gridArr.length; i++) {
    if (Math.floor(Math.random() * 2) === 1) {
      ...
      var ecn = gridArr[i].className;
      console.log(ecn);
    } else {
      gridArr[i].classList.add("green");
      var _ecn = gridArr[i].className;
      console.log(_ecn);
    }
  }
}
...
window.addEventListener("click", function (e) {
  ...
  if (target.className === 'square red' || e.target.className === 'square green') {
    ...
    for (var i = 0; i < gridArr.length; i++) {
      if (gridArr[i].getAttribute('line') === line || gridArr[i].getAttribute('col') === col) {
        Colors(gridArr[i]);
      }
    }
  }
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","../src/pilots/script.js"], null)
//# sourceMappingURL=/script.80a03923.js.map